...
CREATE TABLE `news_post_basic` (
  `post_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '帖文ID',
  `user_id` bigint(20) unsigned NOT NULL COMMENT '用户ID',
  `channel_id` int(11) unsigned NOT NULL COMMENT '频道ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='贴文基本信息表';

CREATE TABLE `news_post_content` (
  `post_id` bigint(20) unsigned NOT NULL COMMENT '帖文ID',
  `content` longtext NOT NULL COMMENT '帖文内容',
  PRIMARY KEY (`post_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='帖文内容表';

CREATE TABLE `news_post_statistic` (
  `post_id` bigint(20) unsigned NOT NULL COMMENT '帖文ID',
  ...
  PRIMARY KEY (`post_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='帖文统计表';
